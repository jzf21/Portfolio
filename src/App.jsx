                    ...
                    <Parallax speed={20}>
                      <div className="px-5 text-xl md:text-3xl selection:text-[#0e0d0d] selection:bg-[#ead2ab] tracking-wide">
                        ...
                        <p className="tracking-wide ">
                          <br />
                          As a dedicated and skilled full-stack student
                          developer, I'm on a never-ending adventure to tinker,
                          code, and create. With a year of experience in
                          developing innovative applications and websites, I'm
                          constantly pushing the limits of what's possible. I'm
                          always eager to collaborate with fellow students and
                          to innovate on exciting new projects, bringing my
                          passion for programming to every endeavor.
                        </p>
                      </div>
                    </Parallax>
                  </div>
