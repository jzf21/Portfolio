...
const SelectedProjects=({name,title,description,img,link,index})=>{
    return (
      <div className="flex flew-row border-[#2c363f] border-[2px] w-[100%]">
        {index % 2 === 0 ? (
        ...
        <div className="flex flex-col justify-center gap-8  self-center w-full  text-left p-black ml-10 ">
...
const SelectedWorks = () => {
  ...
  return (
    <div className="w-[100%] px-40 flex flex-col justify-center">
      <div className="w-[150px] p-1 mb-4 bg-peach"></div>
      <p className="text-5xl leading-25 p-black font-bold mb-4  ">
        SELECTED <br />
        WORKS
      </p>
