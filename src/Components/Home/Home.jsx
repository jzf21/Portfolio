...
const Home = () => {
  return (
    <div className=" h-[100vh] flex flex-col p-10 md:px-20 justify-center gap-4 items-start tracking-wide selection:text-[#0e0d0d] selection:bg-[#ead2ab]">
      ...
      <h1 className="md:text-left text-[3.2em] md:text-[6em] uppercase items-center  weight-1000 text-[#2C363F] tracking-wider relative z-10  ">
        I'm Jozef Antony
        <br /> Full-Stack Developer
      </h1>
      <p className='w-[80%] md:w-[50%] text-sm md:text-xl p-black'>
